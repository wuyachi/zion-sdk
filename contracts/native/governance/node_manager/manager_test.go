...
// go test -v -count=1 github.com/devfans/zion-sdk/contracts/native/governance/node_manager -run TestPropose
...
// go test -v -count=1 github.com/devfans/zion-sdk/contracts/native/governance/node_manager -run TestVote
