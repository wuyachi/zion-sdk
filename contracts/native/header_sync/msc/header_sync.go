...
func getGenesis(native *native.NativeContract, chainID uint64) (genesisHeader *types.Header, err error) {
...
func storeGenesis(native *native.NativeContract, params *scom.SyncGenesisHeaderParam, genesisHeader *types.Header) (err error) {
...
func snapshot(native *native.NativeContract, number uint64, hash ecommon.Hash, targetSigner ecommon.Address, ctx *Context) (snap *Snapshot, lastSeenHeight uint64, err error) {
	var (
...
func verifyHeader(native *native.NativeContract, header *types.Header, ctx *Context) (err error) {
...
func verifyCascadingFields(native *native.NativeContract, header *types.Header, ctx *Context) (err error) {
...
func verifySeal(native *native.NativeContract, header *types.Header, ctx *Context) (err error) {
