...
// SyncGenesisHeader ...
func (h *BorHandler) SyncGenesisHeader(native *native.NativeContract) (err error) {
...
func getGenesis(native *native.NativeContract, chainID uint64) (genesisHeader *HeaderWithOptionalSnap, err error) {
...
func storeGenesis(native *native.NativeContract, params *scom.SyncGenesisHeaderParam, genesisHeader *HeaderWithOptionalSnap) (err error) {
...
// SyncBlockHeader ...
func (h *BorHandler) SyncBlockHeader(native *native.NativeContract) error {
...
func isHeaderExist(native *native.NativeContract, headerHash ecommon.Hash, ctx *Context) (bool, error) {
...
func putCanonicalHash(native *native.NativeContract, chainID uint64, height uint64, hash ecommon.Hash) {
...
func verifyHeader(native *native.NativeContract, headerWOP *HeaderWithOptionalProof, ctx *Context) (snap *Snapshot, err error) {
...
func putSpan(native *native.NativeContract, ctx *Context, span *Span) (err error) {
...
func getSpan(native *native.NativeContract, ctx *Context) (span *Span, err error) {
...
func validateHeaderExtraFieldWithSpan(native *native.NativeContract, headerWOP *HeaderWithOptionalProof, ctx *Context, span *Span) (err error) {
	if span == nil {
...
func getSnapshot(native *native.NativeContract, parent *HeaderWithDifficultySum, ctx *Context) (s *Snapshot, err error) {
...
// SyncCrossChainMsg ...
func (h *BorHandler) SyncCrossChainMsg(native *native.NativeContract) error {
	return nil
}
