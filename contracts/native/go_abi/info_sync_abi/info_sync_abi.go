...
// IInfoSyncMetaData contains all meta data concerning the IInfoSync contract.
var IInfoSyncMetaData = &bind.MetaData{
...
// Deprecated: Use IInfoSyncMetaData.ABI instead.
var IInfoSyncABI = IInfoSyncMetaData.ABI

// Deprecated: Use IInfoSyncMetaData.Sigs instead.
// IInfoSyncFuncSigs maps the 4-byte function signature to its string representation.
var IInfoSyncFuncSigs = IInfoSyncMetaData.Sigs
